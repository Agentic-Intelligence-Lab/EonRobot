...
class AssemblyEnv(DirectRLEnv):
    ...
    def _init_tensors(self):
        ...
        self.held_pos_init_rand = torch.zeros((self.num_envs, 3), device=self.device)
    ...
    def randomize_held_initial_state(self, env_ids, pre_grasp):
        ...
        if pre_grasp:
            ...
            self.held_pos_init_rand[env_ids] = held_pos_init_rand @ torch.diag(held_asset_init_pos_rand)
