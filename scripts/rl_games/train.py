...
parser.add_argument("--assembly_id", type=str, default=None, help="Assembly asset ID for AutoMate tasks.")
parser.add_argument("--log_eval", action="store_true", help="Log evaluation results during training.")
